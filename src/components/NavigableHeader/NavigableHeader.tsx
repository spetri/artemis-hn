...
export const NavigableHeader: FC<NavigableHeaderProps> = ({ title, actions }) => {
  useDash();
      ...
      <View style={header()}>
        ...
        {actions != null ? (
          <TouchableHighlight
            ...
            style={navButton('visible')}
            onPress={() => {
              actionSheet.showActionSheetWithOptions(actions.options, actions.callback);
            }}
          >
            <View>
...
const navButton = styles.lazy<'hidden' | 'visible', ViewStyle>((visibilty) => (t) => ({
  alignItems: 'center',
